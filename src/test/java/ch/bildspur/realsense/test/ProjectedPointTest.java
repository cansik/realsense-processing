 ...
 */
public class ProjectedPointTest extends PApplet {
    ...
    public static void main(String... args) {
        ProjectedPointTest sketch = new ProjectedPointTest();
        sketch.runSketch();
    }
    ...
    public void draw() {
        ...
        if(mouseX < VIEW_WIDTH && mouseY < VIEW_HEIGHT)
        {
            ...
            fill(255, 255, 0);
            textSize(20);
            text("Depth: " + nfp(camera.getDistance(x, y), 0, 2) + "m", mouseX, mouseY + 10);
            text("Point: " + camera.getProjectedPoint(x, y), mouseX, mouseY + 20);
        }
